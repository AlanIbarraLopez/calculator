...
public class WIndow extends javax.swing.JFrame {
    ...
    public WIndow() {
        ...
        pane=this.jPanel1;
        icon=new ImageIcon("src/Imagenes/calcu.png");
        campo="";
        this.setTitle("JCalc");
        ope=new Operaciones();
        area.setText("0");
        this.setIconImage(new ImageIcon(getClass().getResource("Imagenes/calcu.png")).getImage());
    }
    ...
    private void initComponents() {
        ...
        area.setFont(new java.awt.Font("DokChampa", 1, 14)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(area, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
                .addGap(18, 18, 18)
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        // cambiar tema
       Temas theme=new Temas(this,true);
       theme.panel=pane;
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        // acerca de..
        showMessageDialog(this,"By: Alan E. Ibarra-López","Acerca de..",INFORMATION_MESSAGE,icon);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        //igual
        try{
            num2=Double.parseDouble(campo);
            switch(numClave){
                case 1:
                    campo=""+ope.sumas(num1, num2);
                    area.setText(""+campo);
                    break;
                case 2:
                    campo=""+ope.restas(num1, num2);
                    area.setText(""+campo);
                    break;
                case 3:
                    campo=""+ope.mul(num1, num2);
                    area.setText(""+campo);
                    break;
                case 4:
                    campo=""+ope.div(num1, num2);
                    area.setText(""+campo);
                    break;
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        //%
        num2=Double.parseDouble(campo)/100;
        campo=""+ope.mul(num1, num2);
        area.setText(""+campo);
